...
//     return '' + a + b + c; //якщо є хоча б один операнд в сумуванні є рядок, то всі числа стануть рядком, як телепузік :)
//     // return 100 * a + 10 * b + c;
//     // return a + b + c;
// }
...
// // console.log(r.ra, r.rb);
// console.log(r.x, r.y);
// r.ra //поверне a
// r.rb //поверне b


// const arr = ['Hello', false, 12, 'Bob', 42.67]; // не робити так з масивом, бо тут різні типи, краще - масив наприклад тільки чисел
...
// let arr2 = new Array(5); // можна створити масив одразу з N порожніх 'empty' елементів
...
// for(let i=0; i<arr.length; i++){ // Класичний прохід циклу по масиву
//     console.log(arr[i]);
// }

// console.log('<<======================================>');
// for(let key in arr){ // цикл пропустить порожні 91
//     console.log(arr[key]);
// }
...
// const last = arr.pop(); //видаляє одне останнє значення
...
// arr.forEach(el => { //forEach не повенртає масив, він повертає undifine
//     arResult.push(el + 10);
// });
