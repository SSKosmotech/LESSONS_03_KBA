...
const Adddeletemodal = {
    ...
    props: {
        titleadd: {
            type: String,
            default: 'Added In Faforites',
            required: true
        }
        // titledel: {
        //     type: Text,
        //     default: 'Deleted from Faforites',
        //     required: false
        // },
        // showaboutaddedmodal2: {
        //     type: Boolean,
        //     default: true,
        //     required: true
        // }
    ...
    methods: {
        showAboutAddedModalFunc() {
            // this.$parent.getMovieInfo(id)
            this.$emit("showaboutaddedmodalfunc1")
        }
    },
    template: '#adddeletemodal'
}
...
const App = {
    ...
    methods: {
        ...
        showAboutAddedModalFunc(){
            this.showAboutAddedModal = false
        },
        goToPage(pageNum) {
            this.page = pageNum
